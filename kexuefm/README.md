...
then we have url of all archieves.

you can also analyze the elements by using [skill/dev-browser](https://github.com/SawyerHood/dev-browser/tree/main/skills/dev-browser) :
...
I saved content page as `kexuefm\content20260114.html`，then I just put "read kexuefm\content20260114.html, fetch all archieves as html, put in kexuefm\src_archieves" to my opencode
